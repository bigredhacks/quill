...
controller.sendAcceptedEmail = function (email, callback) {
  var options = {
    to: email,
    subject: "[ACTION REQUIRED] [" + HACKATHON_NAME + "] - You've been approved! Confirm your attendance now!"
  };

  var locals = {
    title: 'Your application has been approved!',
    subtitle: '',
    body: 'Congratulations! Your application has been approved! Please log back in to confirm your attendance!',
    actionUrl: ROOT_URL,
